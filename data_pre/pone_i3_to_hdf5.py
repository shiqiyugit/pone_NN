...
input_files = sorted(glob.glob("/mnt/scratch/yushiqi2/pone_linefit/GenerateSingleMuons_*_photonprop_daqSim_noise_ON_clean_linefit.i3.gz"))
...
if isinstance(input_files, list):
    for input_file in input_files:
        output_file = "/mnt/scratch/yushiqi2/pone_linefit/" + strip_i3_ext(input_file, keep_path=False) + ".hdf5"
